...
This module configures Alembic to work with SQLModel metadata and
...
from symbiosis.database import metadata
...
def run_migrations_online() -> None:
    ...
    # Override the sqlalchemy.url config with the environment variable
